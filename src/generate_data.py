...
def masked_matrix(M=_M,N=_N,d=_d):
...
def sp_rand(M=_M,N=_N,d=_d):
    A = sparse.rand(M,N,density=d,format="csc")*4
    A.data+=1
    return A.tocoo()
...
#   matrix (default), masked_matrix, DOK, LIL, COO, CSR
